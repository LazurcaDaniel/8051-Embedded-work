      ...
      000064 75 90 FE         [24]  328 	mov	_P1,#0xfe
                                    329 ;	.\src.c:7: unsigned char x = 0b00000001;
      000067 7E 01            [12]  330 	mov	r6,#0x01
                                    331 ;	.\src.c:8: while(1){
      000069                        332 00109$:
                                    333 ;	.\src.c:9: if(i == 0)
      000069 EF               [12]  334 	mov	a,r7
      00006A 70 0C            [24]  335 	jnz	00106$
                                    336 ;	.\src.c:11: x = x << 1;
      00006C 8E 05            [24]  337 	mov	ar5,r6
      00006E ED               [12]  338 	mov	a,r5
      00006F 2D               [12]  339 	add	a,r5
      000070 FE               [12]  340 	mov	r6,a
                                    341 ;	.\src.c:12: if(x == 0b10000000)
      000071 BE 80 0D         [24]  342 	cjne	r6,#0x80,00107$
                                    343 ;	.\src.c:14: i = 1;
      000074 7F 01            [12]  344 	mov	r7,#0x01
      000076 80 09            [24]  345 	sjmp	00107$
      000078                        346 00106$:
                                    347 ;	.\src.c:18: x = x>>1;
      000078 EE               [12]  348 	mov	a,r6
      000079 C3               [12]  349 	clr	c
      00007A 13               [12]  350 	rrc	a
      00007B FE               [12]  351 	mov	r6,a
                                    352 ;	.\src.c:19: if(x == 0b00000001)
      00007C BE 01 02         [24]  353 	cjne	r6,#0x01,00107$
                                    354 ;	.\src.c:21: i = 0;
      00007F 7F 00            [12]  355 	mov	r7,#0x00
      000081                        356 00107$:
                                    357 ;	.\src.c:24: P1 = ~x;
      000081 EE               [12]  358 	mov	a,r6
      000082 F4               [12]  359 	cpl	a
      000083 F5 90            [12]  360 	mov	_P1,a
                                    361 ;	.\src.c:26: }
      000085 80 E2            [24]  362 	sjmp	00109$
                                    363 	.area CSEG    (CODE)
                                    364 	.area CONST   (CODE)
                                    365 	.area XINIT   (CODE)
